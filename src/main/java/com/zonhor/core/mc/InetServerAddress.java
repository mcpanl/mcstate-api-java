 ...
 *
 */
public class InetServerAddress extends com.zonhor.core.mc.MinecraftServer.Address {
    ...
    private InetServerAddress(com.zonhor.core.mc.MinecraftServer.Address address) throws UnknownHostException {
        super(address);
    ...
    public static InetServerAddress resolve(com.zonhor.core.mc.MinecraftServer.Address address) throws UnknownHostException {
    ...
    public static InetServerAddress resolve(String address) throws URISyntaxException, UnknownHostException {
        return resolve(new com.zonhor.core.mc.MinecraftServer.Address(address));
    }
