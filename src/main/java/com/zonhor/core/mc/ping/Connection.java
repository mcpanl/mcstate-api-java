package com.zonhor.core.mc.ping;
...
public class Connection implements AutoCloseable {
    ...
    public static class Connector {
        ...
        public static Connection connect2(String address, int port) throws ConnectException {
            try {
                ...
                System.out.println("TCP用时：" + latency);
        ...
        public Connection connect(String address, int port) throws ConnectException {
            try {
                Socket socket = new Socket();
                // Socket may be closed and immediately rebound/reconnected
                socket.setReuseAddress(true);
