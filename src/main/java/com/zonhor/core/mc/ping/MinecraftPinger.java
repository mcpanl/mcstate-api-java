...
import com.zonhor.core.mc.ping.Connection.RequestPacket;
import com.zonhor.core.mc.ping.Connection.ResponsePacket;
...
public class MinecraftPinger implements Pinger {
    ...
    public PingResponse pingServerStatus() throws IOException {
        ...
        try (Connection connection = connect()) {
            ...
            System.out.printf("执行时长：%d 毫秒.", (endTime1 - startTime1));
            System.out.println("");
